class InfosController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @info.update(info_params)
        format.html { redirect_to root_path, success: "Info was successfully updated." }
      else
  ...
  private
    ...
    def info_params
      params.require(:info).permit(:main_title, :main_subtitle, :secondary_title, :secondary_subtitle, :about)
    end
end
